...
while place_order:
    ...
    if menu_category.isdigit():
        ...
        if int(menu_category) in menu_items.keys():
            ...
            menu_item_number = input("Type the menu item numer: ")
            ...
            if menu_item_number.isdigit():
                ...
                if menu_item_number in menu_items.keys():
                    ...
                    print(f"Please enter a valid number for the menu item")

                # Tell the customer they didn't select a menu option
            else:
                print(f"your selection was not a menu option")
        else:
            # Tell the customer they didn't select a menu option
            print(f"your selection was not a menu option.")
    else:
    ...
    while True:
        ...
        if keep_ordering in ["Y","y"]:
                # Keep ordering
            break
                # Exit the keep ordering question loop
        elif keep_ordering in ["N", "n"]:
                # Complete the order
            place_order = False
...
print (f"Toral cost of your order is: ${total_cost}")
